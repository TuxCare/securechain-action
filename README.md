...
action was published with: `v0.1.12`.
...
`@v0` follows the newest release of the 0.x line; `@v0.1.12` pins one
...
|---|---|---|
| `version` | `v0.1.12` | CLI release to run, `vX.Y.Z`. Checksum-verified. |
